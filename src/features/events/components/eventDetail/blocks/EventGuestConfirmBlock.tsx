...
import { Button, Card, Checkbox, Flex, Typography, message } from 'antd'
...
import type { EventGuestConfirmVariant } from '../types'
...
export function EventGuestConfirmBlock({
  ...
  const validateCurrentGuest = () => {
    ...
    if (!result.valid) {
      showValidationMessage(t, result, fieldDefinitions)
    }
    return result.valid
  }
